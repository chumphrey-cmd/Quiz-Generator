...
* **Additional Reasoning:** Currently there's an explain button that takes the content of the questions and provides an answer, I now want the ability to chat and interact with the question with a embedded interface (e.g., like the O'Rielly feature...)
* **Local Database:** Be able to store and save your quiz questions into a backend, local database for reference later...
  ...
  * Have the ability for your most missed questions to be marked and reviewed rather than having to retake the entire quiz all over again.
* **UI/UX:** create a nice splash/introduction page/logo for the tool when the user first opens up the quiz.html file.
